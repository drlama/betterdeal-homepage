        ...
        <div class="row g-4">
          <div class="col-md-4">
            <div class="card p-4 h-100">
              <div class="text-bd mb-2"><i class="bi bi-shield-lock fs-4"></i></div>
              <h6 class="fw-semibold">1) Preisgarantie</h6>
              <p class="small text-muted mb-0">Mit unserem Preisrechner ermitteln Sie sofort einen garantierten Verkaufspreis – Sicherheit ohne Risiko.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card p-4 h-100">
              <div class="text-bd mb-2"><i class="bi bi-tools fs-4"></i></div>
              <h6 class="fw-semibold">2) Renovierung auf unsere Kosten</h6>
              <p class="small text-muted mb-0">Wir modernisieren das Objekt komplett – Planung und Umsetzung aus einer Hand.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card p-4 h-100">
              <div class="text-bd mb-2"><i class="bi bi-graph-up-arrow fs-4"></i></div>
              <h6 class="fw-semibold">3) Verkauf mit Bonus</h6>
              <p class="small text-muted mb-0">Erzielen wir durch die Renovierung einen höheren Erlös, erhalten Sie den Bonus aus dem Mehrerlös zusätzlich.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="why" class="py-5">
      <div class="container">
        <div class="text-center mb-4">
          ...
          <div class="text-muted">Für Eigentümer & Makler – wenn eine Immobilie im unsanierten Zustand nicht verkäuflich ist</div>
        </div>
        <div class="row g-3 usp">
          ...
          <div class="col-md-3">
            <div class="card p-4 h-100">
              ...
              <div class="fw-semibold">Garantierter Verkaufspreis</div>
              <div class="small text-muted">Sicherheit durch Preisgarantie</div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card p-4 h-100">
              <div class="text-bd mb-1"><i class="bi bi-people fs-4"></i></div>
              <div class="fw-semibold">Bonus aus Mehrerlös</div>
              <div class="small text-muted">Sie profitieren doppelt: Preis + Bonus</div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card p-4 h-100">
              <div class="text-bd mb-1"><i class="bi bi-lightning-charge fs-4"></i></div>
              <div class="fw-semibold">Rundum-Service</div>
              <div class="small text-muted">Wir kümmern uns um alles – bis zum Notartermin</div>
            </div>
          </div>
        </div>
      </div>
