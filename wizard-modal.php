<?php
// Enhanced Modal: 5-step Preisrechner Wizard
?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="stepper small">
          ...
          <div class="step" data-step="4"><span class="dot">4</span><span class="label">Ausstattung</span></div>
        ...
        <div class="row g-4">
          <div class="col-lg-8">
            ...
            <form id="preisrechnerForm" class="needs-validation" novalidate>
              ...
              <!-- STEP 3: Basisdaten (dynamic fields) -->
              <div class="wizard-step d-none" data-step="3">
                <h6 class="mb-3">Basisdaten</h6>
                <div id="basisWohnungHaus">
                  <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6" id="fieldWohnflaeche">
                      ...
                      <div class="input-icon"><i class="bi bi-aspect-ratio"></i><input type="number" class="form-control" name="b_wohnflaeche" min="1" step="0.1" required></div>
                    </div>
          ...
          <div class="col-lg-4">
            <div class="summary">
              ...
              <div id="liveSummary">
                ...
                <div class="item"><div class="k">Wohn-/Gesamtfläche</div><div class="v text-end" data-k="b_wohnflaeche">–</div></div>
