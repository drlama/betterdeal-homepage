...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top border-bottom"><div class="container">
  ...
  <a class="navbar-brand d-flex d-lg-none align-items-center gap-2 brand-mobile" href="index.php"><img src="/assets/img/icon.png?v=2" width="28" height="28" class="me-2"><span class="fw-bold">BetterDeal</span></a>
